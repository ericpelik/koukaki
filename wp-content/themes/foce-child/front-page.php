    ...
    <main id="primary" class="site-main">
        <section class="banner">
            ...
            <video class="banner-video" autoplay loop muted > 
                <source src= "<?php echo get_stylesheet_directory_uri() . '/assets/videos/videoKoukaki.mp4'; ?> " type="video/mp4">
            </video>
        </section>
        <section id="#story" class="story">
            ...
            <article id="characters">
                <div class="main-character">
                    ...
                    <?php
                        echo get_template_part('template/swiper');
                    ?>
                </div>
        ...
        <section id="studio">
            ...
            <section class="oscars">
                <div class="texte-oscars"> 
                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/images_koukaki/Rectangle_23.png'; ?> " alt="fond oscars">
                    <h3>Fleurs d’oranger & chats errants est nominé aux Oscars Short Film Animated de 2022 !</h3>
                </div>
                <img src="<?php echo get_stylesheet_directory_uri() . '/assets/images_koukaki/oscars.png'; ?> " alt="logo oscars">
            </section>
